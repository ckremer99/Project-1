...
resetButtonElement.addEventListener("click", (event) => {
    ...
    bodyElement.style.backgroundColor = "#000099"
    generateBoard(bombArr);
    render();
});

for (let i = 0; i < 64; i++) {
    gridArrayElement[i].addEventListener("click", (event) => {
...
function render() {
    cells.forEach((cell, idx) => {
        ...
        if (cell.isFlagged) {
            ...
            gridArrayElement[idx].innerHTML = '<i class="fa-solid fa-flag fa-rotate-by fa-lg" style="color: #0066ff; --fa-rotate-angle: 330deg;""></i>'
            return;
        } else {
